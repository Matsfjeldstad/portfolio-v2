...
import holidazeDashboard from '@/assets/holidaze-dashboard.png';
import holidazeMap from '@/assets/holidaze-map.png';
import holidazeDatePicker from '@/assets/holidaze-datepicker.png';
