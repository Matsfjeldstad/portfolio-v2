...
import { KvikkLogo } from '@/assets/Logos';
  ...
  return (
    ...
    >
      {/* <motion.div
        ...
        className="pointer-events-none fixed inset-0 z-0 h-full w-screen bg-[radial-gradient(at_bottom_left,_#059669_10%,_transparent_70%)] "
      /> */}
      <motion.div
        style={{ opacity, scale, position }}
        className="top-40 flex max-w-3xl flex-col items-center gap-4 p-4"
      >
        <p className="text-gray-400"> case study into</p>
        <KvikkLogo className="h-[100px] fill-white" />
        <p className="text-xl capitalize text-gray-400 [text-wrap:balance]">
          {' '}
          Generate Email responses using Openais API
        </p>
